...
export const BRAND_PRESETS: BrandPreset[] = [
  ...
  },
  {
    id: "cgb",
    label: "广发银行",
    description: "广发银行 · 广发Claw",
    config: {
      name: "广发Claw", nameEn: "CGBClaw",
      platform: "广发智能", platformEn: "CGB Smart",
      slogan: "相知相伴，全心为你",
      accentColor: "#CC1122",
      logo: "/uploads/brand/cgb-logo.svg", favicon: "/favicon.png",
      systemPrompt: "You are CGBClaw, an AI assistant on the China Guangfa Bank smart platform.",
      agentIdentity: "你是广发Claw，一个专业、热情的广发银行 AI 助手。",
      githubUrl: "", pageTitle: "广发智能 - 相知相伴，全心为你",
    },
  },
